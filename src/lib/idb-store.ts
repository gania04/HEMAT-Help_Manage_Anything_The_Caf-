...
export function openDB(): Promise<IDBDatabase> {
  return new Promise((resolve, reject) => {
    ...
    request.onupgradeneeded = (event: Parameters<typeof JSON.stringify>[0]) => {
...
export async function saveOfflineTransaction(cartItems: Parameters<typeof JSON.stringify>[0][], paymentMethod: string, totalAmount: number) {
