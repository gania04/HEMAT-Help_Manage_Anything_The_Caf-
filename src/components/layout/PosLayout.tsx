...
export function PosLayout({
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row w-full h-full bg-soft-gray overflow-hidden">
      ...
      <aside className="w-full lg:w-[400px] h-[340px] lg:h-auto bg-white border-t lg:border-t-0 lg:border-l border-gray-200 flex flex-col shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.1)] lg:shadow-xl z-20 shrink-0">
        {cartPanel}
      </aside>
    </div>
  );
