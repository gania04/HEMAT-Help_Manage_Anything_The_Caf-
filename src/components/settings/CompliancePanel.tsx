            ...
            {kycStatus ? (
              ...
              <input type="text" name="nib" id="nib" required className="w-full border rounded p-2 text-sm" placeholder="NIB Bisnis" />
                ...
                <div>
                  ...
                  <input id="uploadDocs" type="file" required multiple className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                </div>
